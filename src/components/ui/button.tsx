  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Hero CTA - Steel Blue accent
        hero: "bg-primary text-primary-foreground font-semibold hover:bg-primary/85 tracking-wide uppercase text-xs",
        // Hero outline - subtle platinum border
        heroOutline: "border border-border bg-transparent text-foreground font-medium hover:bg-secondary hover:border-foreground/30 tracking-wide uppercase text-xs",
      },
      size: {
